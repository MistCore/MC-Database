...
-- Structuur van  tabel world.player_factionchange_titles wordt geschreven
...
-- Dumpen data van tabel world.player_factionchange_titles: 22 rows
/*!40000 ALTER TABLE `player_factionchange_titles` DISABLE KEYS */;
INSERT IGNORE INTO `player_factionchange_titles` (`alliance_id`, `horde_id`) VALUES
	(1, 15),
	(2, 16),
	(3, 17),
	(4, 18),
