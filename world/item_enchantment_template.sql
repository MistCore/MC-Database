...
-- Structuur van  tabel world.item_enchantment_template wordt geschreven
...
-- Dumpen data van tabel world.item_enchantment_template: ~29.190 rows (ongeveer)
/*!40000 ALTER TABLE `item_enchantment_template` DISABLE KEYS */;
INSERT IGNORE INTO `item_enchantment_template` (`entry`, `ench`, `chance`, `type`) VALUES
	(61, 6, 7.73, 0),
	(61, 8, 7.31, 0),
	(61, 9, 8.02, 0),
	(61, 15, 3.01, 0),
