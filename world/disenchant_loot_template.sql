...
-- Structuur van  tabel world.disenchant_loot_template wordt geschreven
...
-- Dumpen data van tabel world.disenchant_loot_template: 206 rows
/*!40000 ALTER TABLE `disenchant_loot_template` DISABLE KEYS */;
INSERT IGNORE INTO `disenchant_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `lootmode`, `groupid`, `mincountOrRef`, `maxcount`) VALUES
	(3, 10940, 20, 1, 1, 1, 2),
	(4, 10940, 80, 1, 1, 1, 2),
	(5, 10940, 75, 1, 1, 2, 3),
	(6, 10940, 20, 1, 1, 2, 3),
