...
-- Structuur van  tabel world.game_event_quest_condition wordt geschreven
...
-- Dumpen data van tabel world.game_event_quest_condition: 11 rows
/*!40000 ALTER TABLE `game_event_quest_condition` DISABLE KEYS */;
INSERT IGNORE INTO `game_event_quest_condition` (`eventEntry`, `quest`, `condition_id`, `num`) VALUES
	(33, 11524, 1, 100),
	(33, 11496, 1, 100),
	(35, 11538, 1, 100),
	(35, 11532, 1, 100),
