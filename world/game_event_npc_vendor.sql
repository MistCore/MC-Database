...
-- Structuur van  tabel world.game_event_npc_vendor wordt geschreven
...
-- Dumpen data van tabel world.game_event_npc_vendor: 59 rows
/*!40000 ALTER TABLE `game_event_npc_vendor` DISABLE KEYS */;
INSERT IGNORE INTO `game_event_npc_vendor` (`eventEntry`, `guid`, `slot`, `item`, `maxcount`, `incrtime`, `ExtendedCost`, `type`) VALUES
