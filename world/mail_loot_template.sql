...
-- Structuur van  tabel world.mail_loot_template wordt geschreven
...
-- Dumpen data van tabel world.mail_loot_template: 135 rows
/*!40000 ALTER TABLE `mail_loot_template` DISABLE KEYS */;
INSERT IGNORE INTO `mail_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `lootmode`, `groupid`, `mincountOrRef`, `maxcount`) VALUES
	(87, 6529, 100, 1, 0, 1, 1),
