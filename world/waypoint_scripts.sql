...
-- Structuur van  tabel world.waypoint_scripts wordt geschreven
...
-- Dumpen data van tabel world.waypoint_scripts: 730 rows
/*!40000 ALTER TABLE `waypoint_scripts` DISABLE KEYS */;
INSERT IGNORE INTO `waypoint_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `dataint`, `x`, `y`, `z`, `o`, `guid`) VALUES
