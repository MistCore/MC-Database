...
-- Structuur van  tabel world.game_event_seasonal_questrelation wordt geschreven
...
-- Dumpen data van tabel world.game_event_seasonal_questrelation: 614 rows
/*!40000 ALTER TABLE `game_event_seasonal_questrelation` DISABLE KEYS */;
INSERT IGNORE INTO `game_event_seasonal_questrelation` (`questId`, `eventEntry`) VALUES
	(1657, 12),
	(1658, 12),
	(6961, 2),
	(6962, 2),
